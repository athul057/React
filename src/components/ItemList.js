    ...
    <div className="pt-3">
     <div className="flex justify-between">
      ...
      <div className="relative w-3/12 ">
       ...
       <button className="absolute self-center bottom-0 right-1/3 text-green-700 bg-gray-100 px-4 py-1 rounded-lg text-center hover:bg-gray-200" onClick={handleClick}>Add +</button>
      </div>
     </div >
